...
% How to Start Your Own Algorithmic Trading Businessï¿?
%
% ernest@epchan.com
% www.epchan.com
...
% positions=NaN(length(tday)); % initialize positions array
positions=[length(tday), 2];
positions(1:length(tday), 1:2)=NaN;
